				...
				.addGroup(gl_PatientInformationPanel.createSequentialGroup()
					.addGroup(gl_PatientInformationPanel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_PatientInformationPanel.createSequentialGroup()
							...
							.addGroup(gl_PatientInformationPanel.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_PatientInformationPanel.createSequentialGroup()
									.addComponent(label, GroupLayout.DEFAULT_SIZE, 43, Short.MAX_VALUE)
									.addGap(31))
								.addGroup(gl_PatientInformationPanel.createSequentialGroup()
									.addComponent(label_1, GroupLayout.DEFAULT_SIZE, 71, Short.MAX_VALUE)
									.addGap(3))
								.addGroup(gl_PatientInformationPanel.createSequentialGroup()
									.addComponent(label_2, GroupLayout.DEFAULT_SIZE, 56, Short.MAX_VALUE)
									.addGap(18))
								.addGroup(gl_PatientInformationPanel.createSequentialGroup()
									.addComponent(label_3, GroupLayout.DEFAULT_SIZE, 52, Short.MAX_VALUE)
									.addGap(22))
								.addGroup(gl_PatientInformationPanel.createSequentialGroup()
									.addComponent(label_4, GroupLayout.DEFAULT_SIZE, 65, Short.MAX_VALUE)
									.addGap(9)))
							.addGap(5)
							.addGroup(gl_PatientInformationPanel.createParallelGroup(Alignment.LEADING, false)
							...
							.addGroup(gl_PatientInformationPanel.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_PatientInformationPanel.createSequentialGroup()
									.addComponent(label_5, GroupLayout.DEFAULT_SIZE, 53, Short.MAX_VALUE)
									.addGap(10))
								.addGroup(gl_PatientInformationPanel.createSequentialGroup()
									.addComponent(lblPhone, GroupLayout.DEFAULT_SIZE, 45, Short.MAX_VALUE)
									.addGap(18)))
						...
						.addGroup(gl_PatientInformationPanel.createSequentialGroup()
							.addGap(70)
							.addGroup(gl_PatientInformationPanel.createParallelGroup(Alignment.LEADING)
								.addComponent(lblStreet, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addGroup(gl_PatientInformationPanel.createSequentialGroup()
									.addComponent(lblState, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
									.addGap(4))
								.addGroup(gl_PatientInformationPanel.createSequentialGroup()
									.addComponent(lblZip, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
									.addGap(16)))
							.addGap(335)))
					.addGap(80))
		);
